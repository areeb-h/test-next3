...
var hamburger = ' block absolute h-0.5 w-4 bg-gray-600 transform transition duration-500 ease-in-out '
...
export default function navbar() {
    ...
    return <nav className='shadow-sm py-4 px-5 flex justify-between mb-5 bg-white items-center'>
        <div className='flex'>
