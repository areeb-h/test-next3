...
var contactLinkStyle = 'px-2 py-1 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 ml-0'

export default function Footer() {
    return (
        <div className=' flex-rows items-center justify-center md:flex md:justify-start bg-white static bottom-0 '>
            <div className=' md:w-4/12 py-5 md:pl-5 md:mr-2 lg:mr-3 block text-center md:text-start'>
                <h1 className="text-lg font-bold">Hulhumale&apos; Academic Center</h1>
                <p>Hithigas Magu, Goalhi 3</p>
                <p>Hulhumale&apos;, Male&apos; 23000</p>
            </div>
            <div className=" md:w-5/12 lg:w-4/12 flex-rows md:ml-4 ">
